...
var uIdade = function uIdade(usuario) {
...
console.log(mostraUsuario(nome)); // const promise = () => {
...
var usuario2 = _objectSpread({}, usuarioS, {
  nome: "Gabriel"
});

var usuario3 = _objectSpread({}, usuarioS, {
  endereco: _objectSpread({}, usuarioS.endereco, {
    cidade: "Lontras"
  })
});
...
var user = "Diego";
var idd = 23;
console.log("O usu\xE1rio ".concat(user, " possui ").concat(idd, " anos")); // var nome = "Diego";
// var idade = 23;
// var usuario = {
//   nome,
//   idade,
